...
const PrivacyPolicy = () => {
  return (
    <StyledPrivacyPolicy>
      <Wrapper align="start">
        <h2 className="title bold">Política Privacidade</h2>
        <p>
          A sua privacidade é importante para nós. É política do Brix respeitar
          a sua privacidade em relação a qualquer informação sua que possamos
          coletar no site <a href="https://www.brbrix.com">Brix</a>, e outros
        ...
        <h3 className="bold">Compromisso do Usuário</h3>
        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da
          informação que o Brix oferece no site e com caráter enunciativo, mas
          não limitativo:
        </p><br />
        <ul>
          <li>
          ...
          <li>
            ...
            (softwares) do Brix, de seus fornecedores ou terceiros, para
        ...
        <h3 className="bold">Mais informações</h3>
        <p>
