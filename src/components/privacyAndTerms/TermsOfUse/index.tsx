...
import { StyledTermsOfUse } from "./styles";

const TermsOfUse = () => {
  return (
    <StyledTermsOfUse>
      <Wrapper align="start">
        <h2 className="bold">1. Termos</h2>
        <p>
          Ao acessar ao site <a href="https://www.brbrix.com/">Brix</a>,
        ...
        <h2 className="bold">2. Uso de Licença</h2>
        <p>
          É concedida permissão para baixar temporariamente uma cópia dos
          materiais (informações ou software) no site Brix , apenas para
        ...
        <p>
          ...
          dessas restrições e poderá ser rescindida por Brix a qualquer momento.
        ...
        <h2 className="bold">3. Isenção de responsabilidade</h2>
        <ol>
          <li>
            Os materiais no site da Brix são fornecidos &apos;como estão&apos;.
            Brix não oferece garantias, expressas ou implícitas, e, por este
          ...
          <li>
            Além disso, o Brix não garante ou faz qualquer representação
        ...
        <h2 className="bold">4. Limitações</h2>
        <p>
          Em nenhum caso o Brix ou seus fornecedores serão responsáveis por
          ...
          incapacidade de usar os materiais em Brix, mesmo que Brix ou um
          representante autorizado da Brix tenha sido notificado oralmente ou
        ...
        <h2 className="bold">5. Precisão dos materiais</h2>
        <p>
          Os materiais exibidos no site da Brix podem incluir erros técnicos,
          tipográficos ou fotográficos. Brix não garante que qualquer material
          em seu site seja preciso, completo ou atual. Brix pode fazer
          alterações nos materiais contidos em seu site a qualquer momento, sem
          aviso prévio. No entanto, Brix não se compromete a atualizar os
          materiais.
        </p>
        <h2 className="bold">6. Links</h2>
        <p>
          O Brix não analisou todos os sites vinculados ao seu site e não é
          responsável pelo conteúdo de nenhum site vinculado. A inclusão de
          qualquer link não implica endosso por Brix do site. O uso de qualquer
          site vinculado é por conta e risco do usuário.
        </p>
        <h3 className="bold">Modificações</h3>
        <p>
          O Brix pode revisar estes termos de serviço do site a qualquer
          momento, sem aviso prévio. Ao usar este site, você concorda em ficar
          vinculado à versão atual desses termos de serviço.
        </p>
        <h3 className="bold">Lei aplicável</h3>
        <p>
          Estes termos e condições são regidos e interpretados de acordo com as
          leis do Brix e você se submete irrevogavelmente à jurisdição exclusiva
